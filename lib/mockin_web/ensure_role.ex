defmodule MockinWeb.EnsureRolePlug do
  require Mockin.Repository.Users
    @moduledoc """
    This plug ensures that a user has a particular role.

    ## Example

        plug MockinWeb.EnsureRolePlug, [Role.roles[:user], Role.roles[:admin]]

        plug MockinWeb.EnsureRolePlug, Role.roles[:admin]
    """
    import Plug.Conn, only: [halt: 1]

    alias MockinWeb.Router.Helpers, as: Routes
